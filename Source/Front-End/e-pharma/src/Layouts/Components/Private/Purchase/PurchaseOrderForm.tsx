...
const PurchaseOrderForm = ({loading, editMode, open, onClose, suppliers, data, onChangeData, onSubmit}: { loading: boolean, editMode: boolean, open: boolean, onClose: any, suppliers: Array<any>, data: any, onChangeData: any, onSubmit: any }) => {
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <select
                                        ...
                                        onChange={(e: any) => onChangeData({SupplierId: e.target.value})}>
                                ...
                                <Col md={12}>
                                    <div style={{padding: '5px 10px 5px 10px'}}>
                                        <RadioGroup row aria-label="position" name="position" defaultValue="top">
                                            ...
                                            <FormControlLabel control={<></>} label="Payment Type"/>

                                            <FormControlLabel control={<Radio color="primary" checked={true}/>}
                                                              className={__css_RadioButton} label="Cash"/>
                                            <FormControlLabel control={<Radio color="primary" checked={true}/>}
                                                              className={__css_RadioButton} label="Credit"/>
                                        </RadioGroup>
                                    </div>
                                </Col>
