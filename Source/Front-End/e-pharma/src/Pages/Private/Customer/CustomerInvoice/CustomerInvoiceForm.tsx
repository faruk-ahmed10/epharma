...
const CustomerInvoiceForm = ({loading, editMode, open, onClose, customers, data, onChangeData, onSubmit}: { loading: boolean, editMode: boolean, open: boolean, onClose: any, customers: Array<any>, data: any, onChangeData: any, onSubmit: any }) => {
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <select
                                ...
                                onChange={(e: any) => onChangeData({CustomerId: e.target.value})}>
