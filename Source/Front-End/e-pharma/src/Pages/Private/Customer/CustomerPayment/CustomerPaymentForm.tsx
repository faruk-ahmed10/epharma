...
const CustomerPaymentForm = ({loading, editMode, open, onClose, customers, onChangeCustomer, data, onChangeData, onSubmit}: { loading: boolean, editMode: boolean, open: boolean, onClose: any, customers: Array<any>, onChangeCustomer: any, data: any, onChangeData: any, onSubmit: any }) => {
            ...
            <Dialog
                ...
                <React.Fragment>
                    <Row>
                        ...
                        <Col md={4}>
                            <select
                                className="mr-2 mb-4" value={data.CustomerId}
                                onChange={(e: any) => {
                                    const value = Number(e.target.value);
                                    onChangeData({CustomerId: value});
                                    if(value > 0) {
