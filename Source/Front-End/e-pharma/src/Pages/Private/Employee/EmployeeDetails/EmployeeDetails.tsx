...
class CustomerDetails extends Component<any, any> {
    public state: any;
    private readonly employee_id: string | number | undefined | null;

    public constructor(props: any) {
        super(props);

        this.employee_id = this.props.match.params.id;
        ...
        return (
            <div>
                ...
                <div className="category__header">
                    <Link
                        to={APP.ROUTES.PRIVATE.EMPLOYEES}
                        className={"cbtn cbtn--lg cbtn--primary mr-10"}
                    >
                        <AddIcon/> Manage Employee
                    </Link>

                    <div className="Customer__wrapper">
                        <PersonDetailsHeader personInfo={this.state.EmployeeInfo}/>

                        <Tabs>
                            <Tab title="Personal Info">
                                <PersonDetailsInfo personInfo={this.state.EmployeeInfo}/>
                            </Tab>
                            <Tab title="Total Sell">
                                <OrderList/>
                            </Tab>
                        </Tabs>
                    </div>
