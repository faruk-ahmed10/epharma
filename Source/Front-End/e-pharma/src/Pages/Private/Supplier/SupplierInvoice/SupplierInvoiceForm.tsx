...
const SupplierInvoiceForm = ({loading, editMode, open, onClose, suppliers, data, onChangeData, onSubmit}: { loading: boolean, editMode: boolean, open: boolean, onClose: any, suppliers: Array<any>, data: any, onChangeData: any, onSubmit: any }) => {
