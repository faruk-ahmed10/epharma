...
class Profile extends Component<any, any> {
    ...
    private handleSaveEmployee(): void {
        ...
        // if(Number(this.state.EmployeeFormDialogData.category_id) === 0) {
        ...
        return (
            <>
                ...
                <Dialog
                    ...
                    open={this.state.EmployeeFormDialogOpne}
                    onClose={() => this.setState({EmployeeFormDialogOpne: false})}
                    fullWidth={true}
                    actionBar={
                        this.state.Loading ? (
                            <Button
                        ...
                        <form encType="multipart/form-data">
                            ...
                            <div className="TwoInputField">
                                ...
                                <div className="Image-file">
                                    <label htmlFor="medicine_name">NID Image</label>
                                    <input
                                        type={"file"}
                                        onChange={(e: any) => {
                                            let __data: any = this.state.EmployeeFormDialogData;
